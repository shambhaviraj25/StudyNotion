...
const SignupForm = ({setIsLoggedIn}) => {
  ...
  return (
    <div>
        ...
        <div className='flex bg-richblack-800 p-1 gap-x-1 my-6 rounded-full max-w-max border-b border-richblack-5'>
            <button 
        ...
        <form onSubmit={submitHandler}>
            ...
            <div className='flex gap-x-4 mt-[20px]'>
                ...
                <label className='w-full'>
                    ...
                    <input
                        ...
                        className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px] border-b border-richblack-5'
                    />
                </label>
            ...
            <button className='w-full bg-yellow-50 rounded-[8px] fonr-medium text-richblack-900 px-[12px] py-[8px] mt-6'>
                Create Account
            </button>
